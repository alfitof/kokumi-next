...
export default function Menu() {
  return (
    <div>
      <Navigation />
      <section id="wave">
        <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mt-4 w-full">
          <div class="relative p-4 w-full bg-white rounded-lg overflow-hidden shadow hover:shadow-md" style={{ minHeight: '160px' }}>
            ...
            <h2 class="mt-2 text-gray-800 text-sm font-semibold line-clamp-1">Super Value Pizza</h2>
      ...
      <section style={{ background: '#fbb94f' }}></section>
    </div>
  );
}
