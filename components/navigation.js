    ...
    <nav class="block w-full bg-white text-white py-2 px-10 lg:px-20 lg:py-4">
      <div className="mx-auto flex items-center justify-between text-gray-900">
        <a href="#" className="mr-4 cursor-pointer py-1.5">
          <img src="image/logo.png" alt="" style={{ maxWidth: '80px', position: 'relative' }} />
        </a>
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          {navList}
          <button className="w-full flex justify-center text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2">
            <svg aria-hidden="true" class="w-6 h-5 mr-2 -ml-1" viewBox="0 0 2405 2501" fill="none" xmlns="http://www.w3.org/2000/svg">
              {' '}
